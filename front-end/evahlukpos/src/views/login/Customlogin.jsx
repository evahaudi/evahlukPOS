...
const CustomLogin = () => {
    ...
    return (
        ...
        <section>
            ...
            />
            <Typography variant='h5' align="center" style={{ color: 'white' }}>WELCOME BACK!</Typography>
            ...
            <Typography variant='h6' align="center" style={{ color: 'white' }} >Please choose your role in order to Sign In</Typography>
            </Box>
            <Box>
            <Grid container justifyContent="center">
