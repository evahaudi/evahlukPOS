...
urlpatterns = [
    ...
    path(
        "deleteuserbyusername/<str:username>/",
        DeleteUserByUsername.as_view(),
        name="delete_user_by_username",
    ),
    path(
        "updateuserbyusername/<str:username>/",
        UpdateUserByUsername.as_view(),
        name="update_user_by_username",
    ),
    path(
        "getuserbyusername/",
