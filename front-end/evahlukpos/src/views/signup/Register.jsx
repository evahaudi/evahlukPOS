                    ...
                    <Grid container spacing={3} alignItems="center">
                        <Grid item xs={12} sm={4} className="input-container">
                            ...
                            >
                                ...
                                characters.Must begin with a letter.Letters,
                        ...
                        <Grid item xs={8} sm={4}>
                            ...
                            <Typography
                                id="uidnote"
                                className={
                                    yearFocus && experienceyears && !validyear
                                        ? 'instructions'
                                        : 'offscreen'
                                }
                            >
